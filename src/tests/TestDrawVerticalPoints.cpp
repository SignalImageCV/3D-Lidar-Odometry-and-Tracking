...
int main( int argc, char** argv){
  ...
  ViewerCanvasPtr canvas1 = viewer.getCanvas("drawingSphere1");
  ViewerCanvasPtr canvas2 = viewer.getCanvas("drawingSphere2");
  std::thread processing_thread1(visualizeSphere, canvas1, filename);
  std::thread processing_thread2(visualizeSphere, canvas2, filename);
