...
#include "loam/include/structs.hpp"
#include "loam/include/turboColors.hpp"
...
namespace Loam{
  class SphericalDepthImage {
    ...
    public:
      ...
      void fillWithClusters3D(std::shared_ptr<PointNormalColor3fVectorCloud> clusterPointsPtr);
